...
!define XAMPP_SERVER_FILE "xampp-win32-5.6.20-0-VC11.zip"
!define XAMPP_SERVER_VERSION "5.6.20.0"
!define APACHE_FILE_VERSION "2.4.17.0"
!define APACHE_SERVICE_NAME_DEFAULT "Apache2.4"
; Perl Addon no more used because included in 1.7.3 ZIP file
; XAMPP Perl addon file and version
!define XAMPP_PERL_FILE "xampp-win32-perl-addon-5.10.0-2.2.11-pl22.zip"
!define XAMPP_PERL_VERSION "5.10.0-2.2.11-pl2"
; XML::Simple Perl module
!define XML_SIMPLE_PATH "XML-Simple-2.22"
...
Section "XAMPP Web Server" SEC01
  ...
  DetailPrint "----------------------- CAUTION ------------------------------------"
  DetailPrint "Now launching XAMPP Perl addon setup, please wait..."
  DetailPrint "--------------------------------------------------------------------"
  ZipDLL::extractall "$TEMP\${XAMPP_PERL_FILE}" "$INSTDIR"
  Pop $0
  StrCmp $0 "success" +3
    MessageBox MB_ICONSTOP|MB_OK "XAMPP Perl addons setup errors detected!$\r$\n$\r$\nUnable to continue. Try installing XAMPP Perl addons manually."
    Abort "XAMPP Web Server setup errors detected !"
  DetailPrint "XAMPP Web Server setup finished."
...
MYSQL_SERVICE_NOT_RUNNING:
  ...
  File /a /r "../ocsinventory-server\Apache\"
...
;  File "../ocsinventory-server\etc\ocsinventory\ocsinventory-reports.conf"
  ...
  File /a /r "..\ocsinventory-ocsreports\"
